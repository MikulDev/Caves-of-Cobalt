 ...
 */
public static class Modeldwarf_normal extends ModelBase {
	...
	public Modeldwarf_normal() {
		...
		this.ponytail.setRotationPoint(-1.0F, 0.0F, 2.0F);
		...
		this.beard.setRotationPoint(-4.0F, 0.0F, -3.0F);
		this.beard.addBox(0.0F, 0.0F, 0.0F, 8, 4, 1, 0.0F);
		this.belly = new ModelRenderer(this, 0, 33);
		this.belly.setRotationPoint(0.0F, 4.5F, -1.0F);
		this.belly.addBox(0.0F, 0.0F, 0.0F, 9, 7, 1, 0.0F);
