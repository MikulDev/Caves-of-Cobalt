...
import net.mcreator.coc.procedures.SporeCloudInfectProcedure;
...
public class SporeCloudBBEntity extends CocModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.1f, 0.1f))
						.build("spore_cloud_bb").setRegistryName("spore_cloud_bb");
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				SporeCloudInfectProcedure.executeProcedure($_dependencies);
			}
		}
