...
import net.mcreator.coc.procedures.PhoenixWingsUseProcedure;
...
public class PWingsKeyKeyBinding extends CocModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
		...
		if (type == 0) {
			{
				...
				PhoenixWingsUseProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
