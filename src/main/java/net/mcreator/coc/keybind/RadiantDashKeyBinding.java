...
import net.mcreator.coc.procedures.RadiantDashSetProcedure;
...
public class RadiantDashKeyBinding extends CocModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
		...
		if (type == 0) {
			{
				...
				RadiantDashSetProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
