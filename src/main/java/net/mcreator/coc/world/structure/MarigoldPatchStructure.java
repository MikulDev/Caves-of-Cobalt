...
public class MarigoldPatchStructure extends CocModElements.ModElement {
	...
	public MarigoldPatchStructure(CocModElements instance) {
		super(instance, 1057);
	...
	public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
		event.getRegistry().register(feature.setRegistryName("marigold_patch"));
	}
