	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CocMod.LOGGER.warn("Failed to load dependency entity for procedure RadShield1Display!");
			return false;
		}
		...
		return ((((entity instanceof LivingEntity)
				...
				&& (((entity.getPersistentData().getDouble("dashCool")) <= 66) && ((entity.getPersistentData().getDouble("dashCool")) > 33)));
	}
}
