...
public class CultivatorGUIGui extends CocModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CultivatorGUIGui(CocModElements instance) {
		super(instance, 787);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("cultivator_gui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("coc:textures/cultivator_gui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("coc:textures/crops.png"));
			this.blit(this.guiLeft + 42, this.guiTop + 14, 0, 0, 256, 256, 256, 256);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("coc:textures/seeds.png"));
			this.blit(this.guiLeft + 78, this.guiTop + 48, 0, 0, 256, 256, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Cultivator", 61, 5, -13421773);
		}
