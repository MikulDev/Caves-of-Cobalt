...
import net.mcreator.coc.procedures.RadAxeAbilityProcedure;
...
public class RadiantTopazGoldAxeItem extends CocModElements.ModElement {
		...
		elements.items.add(() -> new AxeItem(new IItemTier() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					RadAxeAbilityProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("gold_axe_radiant"));
	}
}
