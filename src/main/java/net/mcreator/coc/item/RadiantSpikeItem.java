...
import net.mcreator.coc.procedures.RadiantSpikeTickProcedure;
import net.mcreator.coc.procedures.RadiantSpikeHitProcedure;
...
public class RadiantSpikeItem extends CocModElements.ModElement {
	@ObjectHolder("coc:radiant_spike")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletradiant_spike").setRegistryName("entitybulletradiant_spike"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(JungleSoulItem.block, (int) (1));
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				RadiantSpikeHitProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void tick() {
			...
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				RadiantSpikeTickProcedure.executeProcedure($_dependencies);
			}
			if (this.inGround) {
				this.remove();
			}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("coc:textures/radiant_spike.png");
		...
		public void render(ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
			...
			EntityModel model = new ModelRadiantSpike();
