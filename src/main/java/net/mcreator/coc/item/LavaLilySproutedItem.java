...
public class LavaLilySproutedItem extends CocModElements.ModElement {
	@ObjectHolder("coc:lava_lily_sprouted")
	public static final Item block = null;
	public LavaLilySproutedItem(CocModElements instance) {
		super(instance, 902);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lava_lily_sprouted");
		}
			...
			else 
			{
			   if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) 
			   {
			      ...
			      if (ifluidstate.getFluid() == Fluids.LAVA && worldIn.isAirBlock(blockpos1)) 
			      {
			         ...
			         worldIn.setBlockState(blockpos1, LavaLilySproutBlock.block.getDefaultState().with(LavaLilySproutBlock.CustomBlock.FACING, placeDirec), 11);
