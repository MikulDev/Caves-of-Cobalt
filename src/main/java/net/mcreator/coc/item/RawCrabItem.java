...
public class RawCrabItem extends CocModElements.ModElement {
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(2).saturation(0.300000011920929f).setAlwaysEdible().meat().build()));
			setRegistryName("raw_crab");
		}
