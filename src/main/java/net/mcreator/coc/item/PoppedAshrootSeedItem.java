...
public class PoppedAshrootSeedItem extends CocModElements.ModElement {
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(3).saturation(1f).build()));
			setRegistryName("popped_ashroot_seed");
		}
