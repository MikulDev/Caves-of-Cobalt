...
import net.mcreator.coc.procedures.IvoryDaggerInitProcedure;
...
public class SoulboundDaggerItem extends CocModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(200).rarity(Rarity.COMMON));
			setRegistryName("soulbound_dagger");
		}
		...
		public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
			...
			double z = entity.getPosZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				IvoryDaggerInitProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
