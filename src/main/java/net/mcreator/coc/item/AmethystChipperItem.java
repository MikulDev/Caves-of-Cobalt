...
public class AmethystChipperItem extends CocModElements.ModElement {
	...
	public void initElements() {
		...
		}.setRegistryName("amethyst_chipper"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(ItemGroup.TOOLS).maxDamage(600));
		}
