...
import net.mcreator.coc.procedures.RadiantPickaxeTickINVProcedure;
import net.mcreator.coc.procedures.RadiantPickaxeAbilityProcedure;
...
public class RadiantTopzaGoldPickaxeItem extends CocModElements.ModElement {
		...
		elements.items.add(() -> new PickaxeItem(new IItemTier() {
			...
			public ActionResultType onItemUse(ItemUseContext context) {
				...
				ItemStack itemstack = context.getItem();
				{
					...
					RadiantPickaxeAbilityProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				double z = entity.getPosZ();
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					RadiantPickaxeTickINVProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("gold_pickaxe_radiant"));
	}
}
