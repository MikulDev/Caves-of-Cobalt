...
public class MushroomMidigatorItem extends CocModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(ItemGroup.TOOLS).maxDamage(400).rarity(Rarity.UNCOMMON));
			setRegistryName("mushroom_mitigator");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Grants immunity to \u00A79Mushrooms\u00A7f"));
		}
