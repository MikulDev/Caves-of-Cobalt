...
import net.mcreator.coc.procedures.RadaintSwordFireProcedure;
...
public class RadiantTopazGoldSwordItem extends CocModElements.ModElement {
		...
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					RadaintSwordFireProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("gold_sword_radiant"));
	}
}
