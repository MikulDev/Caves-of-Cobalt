...
import net.mcreator.coc.procedures.ChipperUseProcedure;
...
public class MalachiteChipperItem extends CocModElements.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResultType onItemUse(ItemUseContext context) {
				...
				ItemStack itemstack = context.getItem();
				{
					...
					ChipperUseProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("malachite_chipper"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(ItemGroup.TOOLS).maxDamage(400));
		}
