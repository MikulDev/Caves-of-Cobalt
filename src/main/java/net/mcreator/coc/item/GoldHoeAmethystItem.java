...
import net.mcreator.coc.procedures.AmethystHoeUseProcedure;
...
public class GoldHoeAmethystItem extends CocModElements.ModElement {
		...
		elements.items.add(() -> new HoeItem(new IItemTier() {
			...
			public ActionResultType onItemUse(ItemUseContext context) {
				...
				ItemStack itemstack = context.getItem();
				{
					...
					AmethystHoeUseProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("gold_hoe_amethyst"));
	}
}
