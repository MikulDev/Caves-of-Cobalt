...
import net.mcreator.coc.procedures.ShieldProcedureProcedure;
...
public class ShieldPotion extends CocModElements.ModElement {
	...
	public static class EffectCustom extends Effect {
		...
		public EffectCustom() {
			...
			potionIcon = new ResourceLocation("coc:textures/arrow_merge.png");
		}
		...
		public void applyAttributesModifiersToEntity(LivingEntity entity, AbstractAttributeMap attributeMapIn, int amplifier) {
			...
			double z = entity.getPosZ();
			{
				...
				ShieldProcedureProcedure.executeProcedure($_dependencies);
			}
		}
