...
public class LavaWakeParticle extends CocModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public LavaWakeParticle(CocModElements instance) {
		super(instance, 887);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("lava_wake"));
	}
