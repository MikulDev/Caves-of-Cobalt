...
public class AshrootGrowthBlock extends CocModElements.ModElement 
{
	@ObjectHolder("coc:ashroot_bramble")
	...
	public void initElements() {
		elements.blocks.add(() -> new CustomBlock(Block.Properties.create(Material.TALL_PLANTS).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0.2F).sound(SoundType.PLANT)));
	...
	public static class CustomBlock extends Block implements net.minecraftforge.common.IShearable 
	{
	   ...
	   public CustomBlock(Block.Properties properties) {
	      ...
	      setRegistryName("ashroot_bramble");
	   }
