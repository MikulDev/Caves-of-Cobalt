...
import net.mcreator.coc.procedures.CactusUpdateProcedure;
import net.mcreator.coc.procedures.CactusTestProcedure;
import net.mcreator.coc.procedures.CactusDamageProcedure;
...
public class CactusBlock extends CocModElements.ModElement {
	...
	public static class CustomBlock extends WallBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(InfernalBarkItem.block, (int) (1)));
		}
		...
		public void neighborChanged(BlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			}
			{
				...
				CactusTestProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				CactusUpdateProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				CactusDamageProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
