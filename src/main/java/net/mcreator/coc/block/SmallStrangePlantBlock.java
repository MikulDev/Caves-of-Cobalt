...
import net.mcreator.coc.procedures.StrangeFlowerGrowProcedure;
...
public class SmallStrangePlantBlock extends CocModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("small_strange_plant");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				StrangeFlowerGrowProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
