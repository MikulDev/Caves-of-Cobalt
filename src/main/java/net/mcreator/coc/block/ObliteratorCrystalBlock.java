...
import net.mcreator.coc.procedures.OblUpdate3Procedure;
...
public class ObliteratorCrystalBlock extends CocModElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("obliterator_crystal"));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("obliterator_crystal");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("obliterator_crystal");
		}
