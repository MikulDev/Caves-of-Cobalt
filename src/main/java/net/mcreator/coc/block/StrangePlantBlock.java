...
import net.mcreator.coc.procedures.StrangePlantSpawnProcedure;
import net.mcreator.coc.procedures.PlantDestroyDropProcedure;
...
public class StrangePlantBlock extends CocModElements.ModElement {
	@ObjectHolder("coc:strange_plant")
	public static final Block block = null;
	public StrangePlantBlock(CocModElements instance) {
		super(instance, 865);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		RandomPatchFeature feature = new RandomPatchFeature(BlockClusterFeatureConfig::deserialize) {
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
				...
				int y = pos.getY();
				int z = pos.getZ();
				if (!StrangePlantSpawnProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
					return false;
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(SmallStrangePlantBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SmallStrangePlantBlock.block, (int) (1)));
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				PlantDestroyDropProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
