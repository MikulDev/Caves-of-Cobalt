...
import net.mcreator.coc.procedures.FakeStalaMDestroyProcedure;
...
public class FakeStalagmiteBlock extends CocModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fakestalagmite");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				FakeStalaMDestroyProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onBlockClicked(BlockState state, World world, BlockPos pos, PlayerEntity entity) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				FakeStalaMineProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("fakestalagmite", "fakestalagmite", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.AIR.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 5)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(50, 10, 10, 62))));
		}
	}
}
