...
public class TempleBrickWallBlock extends CocModElements.ModElement {
	@ObjectHolder("coc:templebrickwall")
	public static final Block block = null;
	public TempleBrickWallBlock(CocModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(5f, 500f).lightValue(0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).notSolid());
			setRegistryName("templebrickwall");
		}
