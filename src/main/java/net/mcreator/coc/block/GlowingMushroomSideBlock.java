...
import net.mcreator.coc.procedures.SideMushroomTestProcedure;
...
public class GlowingMushroomSideBlock extends CocModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.SLIME).hardnessAndResistance(0f, 1f).lightValue(4).doesNotBlockMovement()
					.notSolid());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("glowing_mushroom_side");
		}
		...
		public void neighborChanged(BlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			}
			{
				...
				SideMushroomTestProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
