...
public class PolishedShaleStairsBlock extends CocModElements.ModElement {
	@ObjectHolder("coc:polished_shale_stairs")
	public static final Block block = null;
	public PolishedShaleStairsBlock(CocModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_shale_stairs");
		}
