...
public class LavaLily1Block extends CocModElements.ModElement {
	@ObjectHolder("coc:lava_lily_alt")
	public static final Block block = null;
	public LavaLily1Block(CocModElements instance) {
		super(instance, 896);
	}
