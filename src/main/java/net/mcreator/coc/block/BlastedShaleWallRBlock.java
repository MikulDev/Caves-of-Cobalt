...
public class BlastedShaleWallRBlock extends CocModElements.ModElement {
	@ObjectHolder("coc:blasted_shale_wall")
	public static final Block block = null;
	public BlastedShaleWallRBlock(CocModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("blasted_shale_wall");
		}
