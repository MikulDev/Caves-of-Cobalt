...
import net.mcreator.coc.procedures.ShroomCapPlaceProcedure;
...
public class ShroomCapPlacerBlock extends CocModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("shroomcapplacer");
		}
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				ShroomCapPlaceProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
