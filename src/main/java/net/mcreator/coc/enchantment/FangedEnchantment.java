...
public class FangedEnchantment extends CocModElements.ModElement {
	@ObjectHolder("coc:fanged")
	public static final Enchantment enchantment = null;
	public FangedEnchantment(CocModElements instance) {
		super(instance, 851);
	}

	@Override
	public void initElements() {
		elements.enchantments.add(() -> new CustomEnchantment(EquipmentSlotType.MAINHAND).setRegistryName("fanged"));
	}
